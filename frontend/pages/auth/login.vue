        ...
        <div class="md:w-[400px] w-[350px] bg-[#111827] p-4 rounded-lg">
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <div class="flex rounded-md border border-slate-200">
                                <Input :type="hiddenPassword ? 'password' : 'text'" placeholder="Type your password" v-bind="componentField" class="border-none rounded-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0"/>
                                <Button type="button" @click="toggleHidden" variant="secondary" class="flex h-10 px-3 py-2 text-sm rounded-none bg-slate-200">
                                    <Icon :name="hiddenPassword ? 'lucide:eye' : 'lucide:eye-off'" class="w-6 h-6"/>
                                </Button>
                            </div>
                        </FormControl>
            ...
            <div class="flex w-full justify-center mt-4 flex-col md:flex-row">
                <Button  variant="link" size="sm" class="text-white text-sm">
                    <NuxtLink to="/auth/register" class="text-white text-sm">Do you need account?</NuxtLink>
                </Button>
